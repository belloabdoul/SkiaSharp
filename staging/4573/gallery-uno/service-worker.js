import { config as unoConfig } from "/SkiaSharp/staging/4573/gallery-uno/package_5947537d7caf45d2b637e3d7377d5ca7521a9741/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('95ce03b2-19d4-4210-af59-c7f90a35ffdc').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '95ce03b2-19d4-4210-af59-c7f90a35ffdc';
