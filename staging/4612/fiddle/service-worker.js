import { config as unoConfig } from "/SkiaSharp/staging/4612/fiddle/package_a5633324362324bb6c2df6eef238ea0169ec4d51/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('18d3c784-4519-4e44-b90a-97fc357aae21').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '18d3c784-4519-4e44-b90a-97fc357aae21';
