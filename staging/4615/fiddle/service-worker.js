import { config as unoConfig } from "/SkiaSharp/staging/4615/fiddle/package_a5633324362324bb6c2df6eef238ea0169ec4d51/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('e9b4824d-f112-4f3e-8868-4f05d5e0d07b').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'e9b4824d-f112-4f3e-8868-4f05d5e0d07b';
