import { config as unoConfig } from "/SkiaSharp/staging/4615/gallery-uno/package_5947537d7caf45d2b637e3d7377d5ca7521a9741/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('d33aa0bc-8b6f-49d7-9f14-69ed8a94cc15').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'd33aa0bc-8b6f-49d7-9f14-69ed8a94cc15';
